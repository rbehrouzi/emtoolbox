...
def csmWriteStar(starfile, star, reindex=False):
    dict_merge2rln={'X_POSITION':'rlnCoordinateX', 
                    'Y_POSITION':'rlnCoordinateY',
                    'FILENAME':'rlnImageName',
                    'NAME':'rlnMicrographName',
                    'ctf_params.df1':'rlnDefocusU',
                    'ctf_params.df2':'rlnDefocusV',
                    'ctf_params.angast_deg':'rlnDefocusAngle',
                    'ctf_params.akv':'rlnVoltage',
                    'ctf_params.cs':'rlnSphericalAberration',
                    'ctf_params.wgh':'rlnAmplitudeContrast'}
...
def csmGetSubset(masterDb, selectList):
    ...
    csmWriteStar("output.star",merged[columns_for_relion])
